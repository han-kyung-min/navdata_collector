...
wd = '/home/hankm/catkin_ws/src/navdata_collector/run_script/data_extractor/potmap2d';
cd(wd) ;
...
base_dir = '/media/data/mydata/former_datasets/colldata/mixed-45K' ;
...
for data_idx=8000 : length(data_dirs)
    ...
    hold on
    plot(rx, ry, 'co', 'markerfacecolor', 'c', 'markersize', 12) ;
    plot(corr_waypts_px(:,1) , corr_waypts_px(:,2) , 'gs', 'MarkerFaceColor', 'g', 'MarkerSize', 4 ); hold on
