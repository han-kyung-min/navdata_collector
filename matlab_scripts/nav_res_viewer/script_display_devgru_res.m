...
topomap_dir = '/home/hankm/python_ws/viznav/depth-nav/deployment/topomaps/T33';
...
base_nav_path = '/media/results/ai_nav_baselines/ablation_study/T33_base/round3' ;
...
exportgraphics(gca, 'devgru_res.png', 'Resolution', 300);
exportgraphics(gca, 'devgru_res.pdf', 'Resolution', 300);
% 
% h2 =figure(2);
% imshow(map_png_rot); hold on;
% % draw topology nodes
