...
base_nav_path = '/media/results/navdp/2026-02-02-13-14' ;
...
legend('Nav traj', 'Start pos', 'Final pos', 'Location', 'SW') ;

trav_dist = sqrt(sum( (nav_traj_m(end,:) - nav_traj_m(1,:)).^2 ) )  ;
exportgraphics(gca, 'navdp_res.png', 'Resolution', 300);
exportgraphics(gca, 'navdp_res.pdf', 'Resolution', 300);
